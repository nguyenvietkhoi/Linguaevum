var shiftbool = false;
var opttablelist = [$('#Hannom').val(), $('#Midchinese').val(), $('#Southmin').val(), $('#Eastmin').val(), $('#Hakka').val(), $('#Mandarin').val(), $('#Yue').val(), $('#Wu').val(), $('#Hankor').val(), $('#Japanese').val(), $('#Sawndip').val(), $('#Tay').val(), $('#SinoThai').val(), $('#SinoLao').val(), $('#SinoTaidam').val(), $('#SinoLanna').val(), $('#SinoTaiyai').val(), $('#SinoTainuea').val(), $('#SinoTailue').val(), $('#SinoTaiyo').val()];
var kblist = ["E→文", "E→글", "글→文"];
var keyboard = 0;
var contents = [];
var condb;
var conlenbuf = 0;
...
function opttableselect(tablesel) {
    quocngu = tablesel;
    switch (quocngu) {
        case 0: opttable = "rubynom"; break;
        case 1: opttable = "rubytriung"; break;
        case 2: opttable = "rubyhok"; break;
        case 3: opttable = "rubyfoo"; break;
        case 4: opttable = "rubyhakk"; break;
        case 5: opttable = "rubymand"; break;
        case 6: opttable = "rubycant"; break;
        case 7: opttable = "rubysou"; break;
        case 8: opttable = "rubykor"; break;
        case 9: opttable = "rubyjap"; break;
        case 10: opttable = "rubycuen"; break;
        case 11: opttable = "rubytay"; break;
        case 12: opttable = "rubythai"; break;
        case 13: opttable = "rubylao"; break;
        case 14: opttable = "rubytaidam"; break;
        case 15: opttable = "rubylanna"; break;
        case 16: opttable = "rubytaiyai"; break;
        case 17: opttable = "rubytainuea"; break;
        case 18: opttable = "rubytailue"; break;
        case 19: opttable = "rubytaiyo"; break;
        default: opttable = "rubynom"; break;
    }
    loadkeyboard();
...
function txtPadKeyPressed(evt) {
    ...
    if (evtK == 16) {
        if (!shiftbool) {
            ...
            if (subtxt.length > 0)
                $("#example").html("<table><tr><td>" + logo2phon(subtxt) + "</td></tr></table>");
        }
    }
...
function txtPadKeyTyped(evt) {
    ...
    if ((optionlist.length != 0) && !isNaN(parseInt(tonechar)) && (evtC != tonechar)) {   //SHIFT + Num
        ...
        if (optionlist.length == 1) {
            if ((quocngu == 8) || (quocngu == 9) || (quocngu == 12) || (quocngu == 13) || (quocngu == 15) || (quocngu == 19)) {
                listUpdate();
            } else {
...
function convertpad(direction) {
    var convtxt = "";
    switch (direction) {
        case 0:
            convtxt = logo2phon($("#txtPad").val());
            break;
        case 1:
            convtxt = phon2logo($("#txtPad").val());
            break;
        default: break;
    }
    if (convtxt.length > 0) {
...
function logo2phon(pad) {
    if (pad == "")
        return "";
    var cubo = selPhone(pad, true);
    var i;
    var ttt;
    ...
    for (i = 1; i < cubo.length; i++) {
        ...
        if ((quocngu == 8) || (quocngu == 9) || (quocngu == 12) || (quocngu == 13) || (quocngu == 15) || (quocngu == 19) )
            ttt = ttt + nextword;
        else if ((nextword.length == 1) || "。、，：；？！…".includes(nextword)) {
...
function phon2logo(pad) {
    if (pad == "")
        return "";
    var cubo = selChar(pad, true);
    var i;
    var ttt = cubo[0];
    for (i = 1; i < cubo.length; i++) {
        ttt = ttt + cubo[i];
...
function selPhone(phrase, defa){
    ...
    for (k = 0; k != word.length; k++) {
        ...
        sql = "select " + optruby + " from " + opttable + " where word='" + fullchar + "' order by level desc";
...
function selChar(phrase, defa) {
    ...
    for (k = 0; k != word.length; k++) {
        ...
        sql = "select word from " + opttable + " where " + optruby + "='" + fullchar + "' order by level desc";
        contents = condb.exec(sql);
        if (contents.length != 0) {
            sss = contents[0].values[0][0];
            if (ext) {
...
function typeChar(text, ch) {
    if (keyboard != 2) {
        switch (quocngu) {
            ...
            case 11: return TELEX(text, ch, 1);
            case 12: return THAI(text, ch);
            case 13: return LAO(text, ch);
            case 14: return TAIDAM(text, ch);
            case 15: return TAITHAM(text, ch);
            case 16: return TAIYAI(text, ch);
            case 17: return TAILE(text, ch);
            case 18: return TAILUE(text, ch);
            case 19: return TAIYO(text, ch);
        }
    }
    return text + ch;
}
...
function TAIYO(text, ch) {
    ...
    switch (roma) {
        ...
        case '\'g': roma = "󲼀"; break;
        case '\'f': roma = "󲼗"; break;
        case '󲼉h': roma = "󲼞"; break;
        case '󲼖h': roma = "󲼕"; break;
        case '\'c': roma = "󲼹"; break;
        case '\'s': roma = "󲼇"; break;
        case '\'t': roma = "󲼍"; break;
        case '\'z': roma = "󲼺"; break;
        case '\'p': roma = "󲼔"; break;
        case '󲼥d': roma = "󲼭"; break;
        case '󲼥b': roma = "󲼮"; break;
        case '󲼥k': roma = "󲼬"; break;
        case '󲼥n': roma = "󲼪"; break;
        case '󲼥m': roma = "󲼫"; break;
        case '󲼥g': roma = "󲼸"; break;
        case '󲼏h': roma = "󲼒"; break;
        case '󲼢j': roma = "󲼋"; break;
        case '\'j': roma = "󲼊"; break;
        case '󲼠r': roma = "󲼜"; break;
        case '\'r': roma = "󲼠"; break;
        case '󲼃v': roma = "󲼣"; break;
        case '\'v': roma = "󲼝"; break;
        case '\'o': roma = "󲼦"; break;
        default: roma = t + tch; break;
    }
...
function speakpad() {
    var voice = "";
    var spkcont = "";
    var convtxt = logo2phon($("#txtPad").val());
    if (convtxt.length > 0) {
        switch (quocngu) {
            ...
            case 12: voice = "Thai Male"; spkcont = convtxt; break;
    ...
    if ($('#keyboard').css("display") == "block") {
        switch (quocngu) {
            ...
            case 8:
                ...
                $('#K82').html("<span style='color: #b1bb13;'>ᅕᅠᄾᅠ<br>ᅐᅠᄿᅠ</span>");
                $('#K84').html("<br>ㅌ");
                $('#K89').html("<br><span style='color: #5c49c7;'>ㅡ</span>");
                ...
                $('#K70').html("<span style='color: #b1bb13;'>ᅔᅠᄼᅠ<br>ᅎᅠᄽᅠ</span>");
            ...
            case 12:
                ...
                $('#K56').html("<span style='color: #d22e9f;'>๘   </span><br><span style='color: #ffc000;'>◌ำ</span>");
                $('#K57').html("<span style='color: #d22e9f;'>๙   </span><br><span style='color: #ffc000;'>◌็</span>");
            ...
            case 13:
                ...
                $('#K57').html("<span style='color: #d22e9f;'>໙   </span><br><span style='color: #ffc000;'>◌ົ</span>");
                ...
                $('#K82').html("<br><span style='color: #13abbb;'>ຮ </span>ร");
            ...
            case 14:
                $('#K192').html("<br>`");
                $('#K48').html("<br><span style='color: #5c49c7;'>◌ꪰ</span>");
                ...
                $('#K66').html("<span style='color: #d22e9f;'>ꪛ   </span><br><span style='color: #13abbb;'>ꪞ  </span>ꪚ");
            ...
            case 15:
                ...
                $('#K51').html("<span style='color: #d22e9f;'>᪓   </span><br><span style='color: #d22e9f;'>᪃ </span><span style='color: #ffc000;'>ᩕ◌ </span>");
                $('#K52').html("<span style='color: #d22e9f;'>᪔   </span><br><span style='color: #d22e9f;'>᪄   </span><span style='color: #ffc000;'> ᩖ</span>");
                ...
                $('#K87').html("<span style='color: #d22e9f;'>ᩐ   </span><br><span style='color: #ffc000;'> ᩪ</span>");
            ...
            case 17:
                ...
                $('#K54').html("<span style='color: #d22e9f;'>◌́   </span><br>ᥴ");
                $('#K55').html("<br>ᥦ");
                $('#K56').html("<br>ᥪ");
                $('#K57').html("<br>ᥫ");
                $('#K81').html("<br>ᥟ");
            ...
            case 18:
                ...
                $('#K89').html("<br><span style='color: #5c49c7;'>ᦊ</span>");
                $('#K85').html("<br>ᦳ");
            ...
            case 19:
                $('#K192').html("<br>`");
                $('#K48').html("<br><span style='color: #5c49c7;'>◌󲼥</span>");
                $('#K49').html("<br><span style='color: #d48600;'>◌󲼻</span>");
                $('#K50').html("<br><span style='color: #d48600;'>◌󲼼</span>");
                $('#K51').html("<br>󲼩");
                $('#K52').html("<br>󲼨");
                $('#K53').html("<br>󲼵");
                $('#K54').html("<br>󲼱");
                $('#K55').html("<br><span style='color: #ffc000;'>◌󲼯");
                $('#K56').html("<br>󲼶");
                $('#K57').html("<br>󲼳");
                $('#K81').html("<br>󲼡");
                $('#K87').html("<br><span style='color: #ffc000;'>◌󲼲</span>");
                $('#K69').html("<br>󲼰");
                $('#K82').html("<span style='color: #b1bb13;'>󲼜</span><br><span style='color: #7ba064;'>󲼠</span>");
                $('#K84').html("<span style='color: #d22e9f;'>󲼍   </span><br><span style='color: #13abbb;'>󲼒 </span>󲼏");
                $('#K89').html("<br>󲼚");
                $('#K85').html("<br>󲼴");
                $('#K73').html("<br>󲼧");
                $('#K79').html("<span style='color: #d22e9f;'>◌󲼦   </span><br>󲼷");
                $('#K80').html("<span style='color: #d22e9f;'>󲼔   </span><br><span style='color: #13abbb;'>󲼕 </span>󲼖");
                $('#K219').html("<br>[");
                $('#K221').html("<br>]");
                $('#K65').html("<br>󲼤");
                $('#K83').html("<span style='color: #d22e9f;'>󲼇   </span><br>󲼉");
                $('#K68').html("<span style='color: #b59bff;'>󲼭</span><br>󲼌");
                $('#K70').html("<span style='color: #d22e9f;'>󲼗   </span><br>󲼘");
                $('#K71').html("<span style='color: #13abbb;'>󲼀 </span><span style='color: #b59bff;'>◌󲼸</span><br>󲼅");
                $('#K72').html("<br><span style='color: #2f80b9;'>󲼢</span>");
                $('#K74').html("<span style='color: #13abbb;'>󲼋   </span><br>󲼊");
                $('#K75').html("<span style='color: #d22e9f;'>󲼁  </span><span style='color: #b59bff;'>󲼬</span><br><span style='color: #90ffc2;'>󲼃</span>");
                $('#K76').html("<br>󲼛");
                $('#K186').html("<br>;");
                $('#K222').html("<br><span style='color: #cc4444;'>'</span>");
                $('#K90').html("<span style='color: #d22e9f;'>󲼺   </span><br>󲼐");
                $('#K88').html("<span style='color: #d22e9f;'>󲼂   </span><br>󲼄");
                $('#K67').html("<span style='color: #d22e9f;'>󲼹   </span><br>󲼈");
                $('#K86').html("<span style='color: #4fd454;'>󲼣</span><br>󲼝");
                $('#K66').html("<span style='color: #b59bff;'>󲼮</span><br>󲼓");
                $('#K78').html("<span style='color: #b59bff;'>󲼪</span><br>󲼑");
                $('#K77').html("<span style='color: #b59bff;'>󲼫</span><br>󲼙");
                $('#K188').html("<br>,");
                $('#K190').html("<br>.");
                $('#K191').html("<br>/");
                $('#K16R').html("<br>⇧");
